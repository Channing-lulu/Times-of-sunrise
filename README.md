...
![another picture is](out/daylight-2024-09.png )
## The phenomenon
...
So I want to extract the sunrise and sunset times in September, and then calculate the daily daylight hours to compare with the 12 hour daylight hours to see if it conforms to natural phenomena.
...
The first image shows the changes in sunrise and sunset times in September 2024, and the second image shows the length of daylight hours per day and their relationship with the autumnal equinox. It can be seen that after the 26th, the nighttime hours are longer than the daylight hours.
